...
public interface CustomerMapper {
    ...
    @Mapping(source = "userDetails.pesel.value", target = "pesel")
    @Mapping(source = "userDetails.gender", target = "gender")
    @Mapping(source = "userDetails.identity_number", target = "identity_number")
    ...
    @Mapping(target = "userDetails.pesel.value", source = "pesel")
    @Mapping(target = "userDetails.gender", source = "gender")
    @Mapping(target = "userDetails.identity_number", source = "identity_number")
